...
<!-- generated with COPASI 4.15 (Build 95) (http://www.copasi.org) at 2016-07-19 15:41:25 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4377" name="D" value="0"/>
          <Constant key="Parameter_4376" name="r1" value="0.0601762"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4375" name="r3" value="3.47033"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4374" name="r4" value="0"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_15">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Compartments[Cytoplasm],Vector=Metabolites[STAT5]" value="6.02214179e+023" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Compartments[Cytoplasm],Vector=Metabolites[data2]" value="6.02214179e+023" type="Species" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Values[r1]" value="0.0601762" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Values[r3]" value="3.47033" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Values[tao]" value="1.8481" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Values[r4_0]" value="0.449372" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Values[v1_0]" value="1" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=NoName,Vector=Reactions[R1]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=NoName,Vector=Reactions[R1],ParameterGroup=Parameters,Parameter=r1" value="0.0601762" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=NoName,Vector=Reactions[R3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=NoName,Vector=Reactions[R3],ParameterGroup=Parameters,Parameter=r3" value="3.47033" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 6.02214179e+023 0 0 0 0 0 0 6.02214179e+023 6.02214179e+023 0 0 0 1 1 0.0601762 3.47033 0 1.8481 0.449372 1 0.06385 0 
    </InitialState>
  </Model>
  <ListOfTasks>
